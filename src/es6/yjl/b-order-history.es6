...
class bOrderHistory extends HTMLElement{
	...
	createStyle(){
		let css = [
			...
			'.showMore{height:30px;padding-top:10px;font-size:12px;color:#909192;}',
...
if(!customElements.get('b-order-history')){
	customElements.define('b-order-history', bOrderHistory );
}
