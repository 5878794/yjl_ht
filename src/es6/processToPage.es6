...
let key = [
	...
	{name:'DIAN_ZI_JILING_AUDIT',value:'../approve/o_approve_advance.html',info:'经理-部门初审',api:'/api/dzOrderFlow/auditOrder'},
	...
	{name:'DIAN_ZI_JITUAN_AUDIT',value:'../publish/review.html',info:'集团-终审',api:''},
		{name:'DIAN_ZI_ZHIXING_SUBMIT_CONTRACT',value:'',info:'执行-提交合同',api:'/api/dzOrderFlow/zhiXingSubmitContract'},
	...
	{name:'DIAN_ZI_QUANZHENG_REPAYMENT_DATA_CONFIRM',value:'../publish/review.html',info:'权证-还款资料确认',api:'/api/dzOrderFlow/zhiXingChuKuanSubmit'},
		{name:'DIAN_ZI_FENGKONG_CHUKUAN_AUDIT',value:'',info:'风控-出款审核',api:''},
	{name:'DIAN_ZI_CAIWU_CHUKUAN_BOOKING',value:'../finance/o_bookkeeping.html',info:'财务-出款记账',api:'/api/dzOrderFlow/caiWuChuKuanBooking'},
		{name:'DIAN_ZI_GONGSI_CHUKUAN_OVER_ORDER',value:'',info:'公司-出款过单',api:'/api/dzOrderFlow/gongSiChuKuanOverOrder'},
		{name:'DIAN_ZI_JITUAN_CHUKUAN_OVER_ORDER',value:'',info:'集团-出款过单',api:'/api/dzOrderFlow/jiTuanChuKuanOverOrder'},
	...
	{name:'DIAN_ZI_QUANZHENG_QUZHENG_JIEYA',value:'../publish/review.html',info:'权证-取证、解压',api:'/api/dzOrderFlow/quanZhengQuZhengJieYa'},
	{name:'DIAN_ZI_QUANZHENG_GUOHU',value:'../publish/review.html',info:'权证-过户',api:'/api/dzOrderFlow/quanZhengGuoHu'},
	{name:'DIAN_ZI_QUANZHENG_GET_NEW',value:'../publish/review.html',info:'权证-取新证',api:'/api/dzOrderFlow/quanZhengGetNew'},
	...
	{name:'FANG_DI_JITUAN_AUDIT',value:'../publish/review.html',info:'集团-终审',api:''},
		{name:'FANG_DI_ZHIXING_SUBMIT_CONTRACT',value:'',info:'执行-提交合同',api:'/api/fdOrderFlow/zhiXingSubmitContract'},
	{name:'FANG_DI_QUANZHENG_DIYA',value:'../publish/review.html',info:'权证-抵押',api:'/api/fdOrderFlow/quanZhengDiYa'},
	...
	{name:'FANG_DI_CAIWU_CONFIRM',value:'../finance/o_business_fee_payment.html',info:'财务-确认业务费缴纳',api:'/api/fdOrderFlow/caiWuConfirm'},
		{name:'FANG_DI_ZHIXING_CHUKUAN_SUBMIT',value:'',info:'执行-出款申请',api:'/api/fdOrderFlow/zhiXingChuKuanSubmit'},
	{name:'FANG_DI_CAIWU_CHUKUAN_BOOKING',value:'../finance/o_bookkeeping.html',info:'财务-出款记账',api:'/api/fdOrderFlow/caiWuChuKuanBooking'},
		{name:'FANG_DI_FENGKONG_CHUKUAN_OVER_ORDER',value:'',info:'风控-出款过单',api:'/api/fdOrderFlow/fengKongChuKuanOverOrder'},
